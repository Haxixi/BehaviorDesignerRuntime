...
public static class BinaryDeserializationDeprecated
{
    ...
    public static void Load(TaskSerializationData taskData, BehaviorSource behaviorSource)
    {
        ...
        {
            foreach (BinaryDeserializationDeprecated.ObjectFieldMap current in BinaryDeserializationDeprecated.taskIDs.Keys)
            {
                List<int> list3 = BinaryDeserializationDeprecated.taskIDs[current];
